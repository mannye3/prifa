		...
		<div class="col-md-9">
			...
			<div class="listings-container list-layout">
				...
				<div class="listing-item">
					...
					<a href="<?php echo URLROOT; ?>/listings/<?php echo $rent_pro->ref_id; ?>" class="listing-img-container">

						<div class="listing-badges">
							<span class="featured"><b>For <?php echo $rent_pro->purpose; ?></b></span>
					...
					<div class="listing-content">
						...
						<div class="listing-title">
							<h4><a href="<?php echo URLROOT; ?>/listings/<?php echo $rent_pro->ref_id; ?>"><?php echo $rent_pro->title; ?></a></h4>
							
								<i class="fa fa-map-marker"></i>
								<?php echo $rent_pro->address; ?>. <?php echo $rent_pro->lga; ?>, <?php echo $rent_pro->state; ?>
							</a>

							<a href="<?php echo URLROOT; ?>/listings/<?php echo $rent_pro->ref_id; ?>" class="details button border">Details</a>
						</div>

						<ul class="listing-details">
							
							<li><?php echo $rent_pro->rooms; ?> Bedroom</li>
							<li><?php echo $rent_pro->bathrooms; ?> Bathroms</li>

							<li>Type : <?php echo $rent_pro->type; ?> </li>							
						</ul>

						<div class="listing-footer">
							<!-- <a href="#"><i class="fa fa-user"></i> Chester Miller</a> -->
							<span><i class="fa fa-eye"></i><?php echo $rent_pro->view; ?> views</span>
						</div>
